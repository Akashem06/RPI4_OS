...
/** @brief Polls mailbox read. Will block until mailbox has data. We check the last 4 bits to verify
 * the channel */
...
bool mailbox_process(MailboxTag *tag, u32 tag_size) {
  // Buffer_size includes the size of the tag, 8 bytes for size and code, and 4 bytes for the
  // property end tag
