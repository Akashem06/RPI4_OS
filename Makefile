...
C_FLAGS = -DRPI_VERSION=$(RPI_VERSION) -Wall -nostdlib -nostartfiles -ffreestanding -Ilib/inc -Iutils/inc -Idrivers/inc -IRPI_Bluetooth/inc -mgeneral-regs-only
ASM_FLAGS = -Iinc
...
ASM_FILES = $(wildcard $(LIB_SRC_DIR)/*.S)
