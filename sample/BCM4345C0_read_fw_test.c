...
void kernel_main() {
    ...
    if (bcm4345c0_test_size != (bcm4345c0_test_end - bcm4345c0_test_ptr)) {
        log("Size mismatch. Linker Size %d. Calculated size %d\n\r", bcm4345c0_test_size, (bcm4345c0_test_end - bcm4345c0_test_ptr));
        return;
    }
    ...
    uint16_t expected_values[] = {
        0x4c, 0xfc, 0x46, 0x00, 0x9c, 0x21, 0x00, 0x42,
        0x52, 0x43, 0x4d, 0x63, 0x66, 0x67, 0x53, 0x00,
        0x00, 0x00, 0x00, 0x32, 0x00, 0x00, 0x00, 0x01,
        0x01, 0x04, 0x18, 0x92, 0x00, 0x00, 0x00, 0x03,
        0x06, 0xac, 0x1f, 0x00, 0xc0, 0x45, 0x43, 0x00,
        0x01, 0x1c, 0x42, 0x9c, 0x21, 0x00, 0x00, 0x00,
    };
